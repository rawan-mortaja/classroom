    ...
    <div class="container">
        ...
        <div class="mt-4 ">
            ...
            <div jsname="tJHJj" jsaction="JIbuQc:jkaCtf" class="WuChGe QRiHXd aHTZpf"><span
                    class="xSP5ic ho6Zoe bxp7vf"><svg focusable="false" width="24" height="24" viewBox="0 0 24 24"
                        class=" NMm5M">
                        <path
                    ...
                    <div class="row mt-4 ">
                        <div class="col-md-1 media-body">
                            <img src="https://ui-avatars.com/api/?name={{ $comment->user->name }}&size=70&background=5EBEF5&color=fff"
                                class="mr-3 WqfsMd" alt="User Avatar">
                        </div>
                        <div class="col-md-11">
                            <div class="media ruTJle">
                                ...
                                <div class="media-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <span class="T8rTjd mr-2">{{ $comment->created_at->diffForHumans(null) }}</span>
