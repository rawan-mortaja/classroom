...
<body class="g-sidenav-show  bg-gray-100">
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="{{ route('classrooms.index') }}" target="_blank">
                <img src="{{ asset('./assets/img/logo-classroom.png') }}" class="navbar-brand-img h-100 "
                    alt="main_logo">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('classrooms.index') }}">

                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">dashboard</i>
                        </div>

                        <span class="nav-link-text ms-1 flex-nowrap">Classrooms</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('classrooms.create') }}">

                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10 ">create</i>
                        </div>

                        <span class="nav-link-text ms-1">Create Classroom</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('classrooms.trashed') }}">
                        ...
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10 "><i class="fa fa-trash" aria-hidden="true"></i></i>
                        </div>

                        <span class="nav-link-text ms-1">Trashed
                            Classroom </span>
                    </a>
                </li>
                ...
                <nav aria-label="breadcrumb">
                    ...
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark"
                                href="{{ route('classrooms.index') }}">Classrooms</a></li>
                        {{-- <li class="breadcrumb-item text-sm text-dark active" aria-current="page">{{ $classroom->name }}</li> --}}
                    </ol>
                    {{-- <h6 class="font-weight-bolder mb-0">{{ $classroom->name }}</h6> --}}
